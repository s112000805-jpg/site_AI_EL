    ...
    lessons: [
      {
        ...
        code: "AI-02-01",
        title: "AI 作為你的思維夥伴",
        description: "學習把 AI 當成共同思考的夥伴，透過提問、追問與觀點比較，協助釐清想法並改善決策。",
        durationSeconds: 430,
        durationLabel: "07:10",
        kind: "教學影片",
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        id: "FcI0VM8J0gQ",
        code: "AI-03-04",
        title: "從零打造一人 AI 公司：教學簡報 1",
        description: "以一人公司為情境，理解如何整合 AI 工具、任務分工與可重複流程，建立個人化的 AI 營運工作流。",
        durationSeconds: 382,
        durationLabel: "06:22",
        kind: "專題影片",
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        id: "QCPs3dVfcO4",
        code: "AI-04-06",
        title: "知識蒸餾：讓 AI 更小、更聰明、更快",
        description: "理解知識蒸餾如何把大型模型的能力轉移到較小模型，兼顧效能、速度與部署成本。",
        durationSeconds: 451,
        durationLabel: "07:31",
        kind: "延伸影片",
      },
